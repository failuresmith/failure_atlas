...
# FM_005 — Unbounded pagination cookie state under repeated discover requests
...
- `test_repro_fm005.py` demonstrates cookie growth exceeds budget without guardrail
- `test_prevent_fm005.py` proves cookie count stays within budget with guardrail
