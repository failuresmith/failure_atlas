...
def test_prevent_fm003_inclusive_comparator_enforces_quota(max_reservations_per_peer: int):
    """FM_003 prevention: inclusive `>=` guard preserves per-peer quota invariant."""
