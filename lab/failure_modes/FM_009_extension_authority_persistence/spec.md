...
# FM_009 — Extension authority persists after uninstall
...
## Acceptance criteria
- `tests/test_repro_fm009.py` shows authority persists after uninstall in baseline registry.
- `tests/test_prevent_fm009.py` shows lifecycle-bound registry revokes authority on uninstall.
- `tests/test_fm009_happy_path.py` shows active extension retains authority while installed.
