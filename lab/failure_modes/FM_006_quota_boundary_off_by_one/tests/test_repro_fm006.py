...
from failure_modes.FM_006_quota_boundary_off_by_one.scenario import run_known_broken_baseline
...
def test_repro_fm003_strict_comparator_allows_one_extra_reservation(
    ...
    """FM_006 repro: strict `>` quota check admits one extra allocation at boundary."""
