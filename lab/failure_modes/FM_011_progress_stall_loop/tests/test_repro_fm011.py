...
from failure_modes.FM_011_progress_stall_loop.scenario import run_without_progress_guard
...
def test_repro_fm011_agent_spins_until_iteration_cap(max_iterations: int, experiment_log):
    """FM_011 repro: identical failing tool call consumes the full iteration budget."""
